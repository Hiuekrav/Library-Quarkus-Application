...
import pl.pas.exceptions.book.BookDeleteException;
import pl.pas.exceptions.book.BookStatusAlreadySetException;
import pl.pas.exceptions.book.BookTitleAlreadyExistException;
...
@ApplicationScoped
public class BookService extends ObjectService implements pl.pas.services.interfaces.IBookService {
