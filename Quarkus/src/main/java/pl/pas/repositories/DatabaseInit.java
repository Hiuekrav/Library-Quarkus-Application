...
@AllArgsConstructor
    ...
    public void init(@Observes StartupEvent event) {
        ...
        userRepository.save(new AdminMgd("Kamil", "Wios",
                "kamil@gmail.com", "password123",
                "Katowice", "Zielona", "15/36"));
        userRepository.save(new LibrarianMgd("Ania", "Klos",
        ...
        bookRepository.save(new BookMgd(null, "Wiedźmin 3", "Sapkowski",
                388, Genre.FANTASY, LocalDate.of(2016, 5, 17),
                0, false));

        bookRepository.save(new BookMgd(null, "GNU/Linux THE MAN-PAGES BOOK", "Rik Faith ",
